...
public class GuiButton extends GuiElement
{
	...
	public GuiButton(Rectangle bounds, int buttonIndex, Texture texture, Texture textureHover, String displayString, Color displayStringColor, Font displayStringFont)
	{
		super(bounds);
